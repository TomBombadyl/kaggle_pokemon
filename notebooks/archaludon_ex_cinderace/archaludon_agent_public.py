"""Archaludon ex + Cinderace — Rule-based agent (Public version v5, 2026-06-26)

Community reference — not wired into agent/ yet. See eval/archaludon_ex_cinderace_candidate.md.
